...
function NewItem() {
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-md w-full space-y-4 bg-white rounded-lg shadow-2xl p-6">
            ...
            <div>
                <select id="category" value={category} placeholder="Category" onChange={(e) => setCategory(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
